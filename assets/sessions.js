...
window.MFML_SESSIONS = [
  ...
  ["opt","05","05_convex_sets_functions","Convex sets & functions","The one property that turns 'search' into 'guaranteed to find the minimum'.",false],
  ["opt","06","06_duality_kkt","Lagrangian duality & KKT","Constraints, multipliers, and the conditions every optimum obeys.",false],
  ["opt","07","07_gradient_methods","Gradient methods & convergence","Momentum, Nesterov, Lipschitz — why step sizes work, and how fast.",false],
  ["opt","08","08_adaptive_second_order","Adaptive & second-order methods","Adam, Newton, L-BFGS — using curvature to move smarter.",false],
  ["inf","09","09_multivariate_gaussians","Multivariate Gaussians & exponential families","The distribution ML runs on, and the family that unifies most of the others.",false],
  ["inf","10","10_mle_fisher","MLE, Fisher information & Cramér–Rao","How much a dataset can possibly tell you about a parameter.",false],
  ["inf","11","11_mcmc","Bayesian inference at scale — MCMC","Sampling from posteriors you can't write down.",false],
  ["inf","12","12_variational_inference","Variational inference & the ELBO","Turning inference into optimization — the engine inside VAEs.",false],
  ["lt","13","13_pac_vc","Bias–variance, PAC & VC dimension","What 'learnable' means, and why capacity controls generalization.",false],
  ["lt","14","14_generalization_bounds","Generalization bounds & Rademacher complexity","Provable guarantees on the gap between train and test error.",false],
  ["it","15","15_mutual_information","Mutual information & f-divergences","Measuring shared information and the distance between distributions.",false],
  ["it","16","16_optimal_transport","Optimal transport & the Wasserstein distance","Moving mass — the geometry-aware distance behind modern generative models.",false],
